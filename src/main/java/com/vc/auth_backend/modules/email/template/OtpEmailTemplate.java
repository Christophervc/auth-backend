...
public class OtpEmailTemplate {
    ...
    /**
     * @param code       código OTP de 6 dígitos en claro (solo existe en memoria)
     * @param minutesValid minutos de validez del código
     * @return HTML del email listo para enviar
     */
                          ...
                          <tr>
                            <td style="padding:36px 40px 24px;">
                              ...
                              <p style="margin:0;font-size:14px;color:#71717a;">
                                ...
                                Tu contraseña actual no ha sido modificada.
                              </p>
                            </td>
                          </tr>
    ...
    public String subject() {
        return "Tu código de recuperación de contraseña";
    }
}